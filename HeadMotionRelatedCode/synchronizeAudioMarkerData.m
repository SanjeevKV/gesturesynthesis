function synchronizeAudioMarkerData(audioDataPath, markerDataPath)
...
for i=1:length(audioFileNames)
    ...
    if exist([markerDataPath,'\',handDistFilename,'HandMarkerDistance.mat'], 'file') == 2
        ...
        tempDist=getDistanceBetweenHands(markerData, 'F:\IIScProjectMain\Optitrack\Code\HandMarkerNames.txt');
        d=(tempDist-min(tempDist))/range(tempDist);
