        ...
        for wc, cur_window in enumerate(windows):
            ...
            for cur_fold in folds:
                if cur_fold.find("bool") != -1:
                    ...
                    cur_user_prediction = df.iloc[cur_user, :]
                    ax[cur_row][cur_col].plot(range(len(cur_user_prediction)), cur_user_prediction)
